...
public class MifCenterParser extends MifDefaultParser implements MifParameterParser
{
	...
	public MifDataParameter parseParameter(MifReader reader)
	{
		...
		return MifCoordinatePairParser.parseCoordinates(coordinates[0], coordinates[1], reader);
	}
}
