...
public class MifSymbolParser extends MifDefaultParser implements MifParameterParser
{
	...
	public MifDataParameter parseParameter(MifReader reader)
	{
		...
		return new MifSymbol(triplet.getParameter1(), triplet.getParameter2(), triplet.getParameter3());
	}
}
